...
_all_settings = [
    ...
    IntSpinner(
        ...
        group=SettingGroup.ITEM_PLACEMENT,
        ui_label="Objectives Required",
        minimum=4,
        maximum=99,  # functional max
        step=1,
        shared=True,
        default=7,
    ...
    Toggle(
        name=settingkey.COMPANION_DAMAGE_TOGGLE,
        group=SettingGroup.COMPANIONS,
        ui_label="Companions Deal Damage to All Enemies and Bosses",
        shared=True,
        default=False,
        tooltip="""
        If enabled, companions will deal normal damage to all enemies and bosses instead
        of just one damage.
        """,
        randomizable=False,
    ),
    Toggle(
        name=settingkey.COMPANION_KILL_BOSS,
        group=SettingGroup.COMPANIONS,
        ui_label="Companions Can Kill Bosses",
        shared=True,
        default=False,
        tooltip="If enabled, companion attacks will be able to kill bosses.",
        randomizable=False,
    ),
    SingleSelect(
    ...
    SingleSelect(
        name=settingkey.JACK_SKELLINGTON_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.JACK_SKELLINGTON_BLAZING_FURY_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Blazing Fury Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.JACK_SKELLINGTON_ICY_TERROR_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Icy Terror Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.JACK_SKELLINGTON_BOLTS_OF_SORROW_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Bolts Of Sorrow Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.SIMBA_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.SIMBA_FIERCE_CLAW_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Fierce Claw Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.SIMBA_GROUNDSHAKER_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Groundshaker Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.ALADDIN_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.ALADDIN_SLASH_FRENZY_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Slash Frenzy Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.ALADDIN_QUICKPLAY_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Quickplay Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.PING_MULAN_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.MULAN_MUSHU_FIRE_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Mushu Fire Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.MULAN_FLAMETONGUE_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Flametongue Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.BEAST_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.BEAST_SHOUT_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Shout Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.BEAST_RUSH_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Rush Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.TRON_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.TRON_SCOUTING_DISK_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Scouting Disk Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.TRON_PULSING_THUNDER_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Pulsing Thunder Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.JACK_SPARROW_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.JACK_SPARROW_NO_MERCY_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="No Mercy Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.JACK_SPARROW_RAIN_STORM_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Rain Storm Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.JACK_SPARROW_BONE_SMASH_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Bone Smash Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.RIKU_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.RIKU_DARK_AURA_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Dark Aura Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.RIKU_DARK_SHIELD_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Dark Shield Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
    ...
    SingleSelect(
        name=settingkey.AURON_MELEE_ATTACKS_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Melee Attack Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
    ...
    SingleSelect(
        name=settingkey.AURON_DIVIDER_KNOCKBACK_TYPE,
        group=SettingGroup.COMPANIONS,
        ui_label="Divider Damage Mode",
        choices=KnockbackTypes.knockback_options(),
        shared=True,
        default=knockbackTypes.JUST_DAMAGE,
        tooltip=KnockbackTypes.damage_type_tooltip(),
